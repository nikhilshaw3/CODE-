...
db.collection('requested_books').where('request_id','==','this.state.request').get()
.then(snapshot=>{
snapshot.forEach(doc=>[
this.setState({
...
<View style={{flex: 1}}>
<Header
leftComponent={<Icon name="arrow_left" type='feather' color='#696969' onPress={()=>this.props.navigation.goBack()}/>}
centerComponent={{text: "Donate Books",style:{color:'#90A5A9',fontSize: 20 ,fontWeight: 'bold'}}}
backgroundColor="#EASF8FE"
...
const styles = StyleSheet.create({ container: { flex:1, }, 
    ...
    button:{ width:200, height:50, justifyContent:'center', alignItems : 'center', borderRadius: 10, backgroundColor: 'orange', shadowColor: "#000", 
